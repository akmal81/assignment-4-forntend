...
const Hero = ({
  badge = "Learn Anythig From dance to cooking",
  heading = "Your Academic Journey, Guided by Experts",
  description = "Stop struggling alone. Search thousands of specialized tutors to find your perfect match and reach your full potential today",
  buttons = {
    primary: {
      text: "Book a Session",
      url: "#",
